...
// Los estilos principales se importarán en App.jsx

function Maquinas() { // <-- Cambio de nombre aquí
            ...
            {maquinas.map(maquina => (
              <tr key={maquina.id}>
                {editingId === maquina.id ? (
                  <>
                    <td>{maquina.id}</td>
                    <td><input type="text" name="nombre" value={editFormData.nombre} onChange={handleEditFormChange} required /></td>
                    <td><input type="number" name="coeficiente" step="0.01" min="1" max="3" value={editFormData.coeficiente} onChange={handleEditFormChange} required /></td>
                    <td>
                  ...
                  <>
                    ...
                    <td>
                      ...
                      <button type="button" className="delete-btn" onClick={() => abrirModalDeConfirmacion(maquina.id)}>Eliminar</button>
                    </td>
                  </>
                )}
              </tr>
...
export default Maquinas; // <-- Cambio de nombre aquí
